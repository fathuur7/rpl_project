...
const ServicesSection = () => {
  ...
  if (error) {
    return (
      <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-red-50 overflow-hidden">
        <div className="container mx-auto px-6">
          <motion.div 
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-gray-50 via-white to-indigo-50 overflow-hidden relative">
              ...
              <Card className="overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 h-full bg-white/80 backdrop-blur-sm border-0 rounded-3xl">
                ...
                >
                  <div className={`w-full h-full flex items-center justify-center relative bg-gradient-to-br ${gradients[index % gradients.length]} shadow-inner`}>
                    ...
                    />
                    <motion.div
                      className="absolute bottom-6 left-6 w-3 h-3 bg-white/40 rotate-45"
                      animate={{ 
                        rotate: [45, 225, 45],
                        scale: [1, 1.2, 1]
                      }}
                    ...
                    <div className="text-center text-white relative z-10">
                      ...
                      <motion.div
                        className="w-12 h-1 bg-white/60 mx-auto rounded-full"
                        initial={{ width: 0 }}
                ...
                <div className="p-8">
                    ...
                    {category.services && Array.isArray(category.services) && (
                      <ul className="space-y-3">
                        {category.services.slice(0, 4).map((service, serviceIndex) => (
                          ...
                          >
                            <motion.div
                              className="w-2 h-2 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full mr-4 flex-shrink-0"
                  ...
                  <motion.div
                    ...
                    whileTap="tap"
                  >
                    <Button className="rounded-2xl w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold py-4 text-lg shadow-lg hover:shadow-xl transition-all duration-300 border-0">
