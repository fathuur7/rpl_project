          ...
          <CardContent className="pt-6">
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-semibold">
                      ${typeof service.budget === 'number' ? service.budget.toLocaleString() : service.budget}
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="text-gray-600 whitespace-pre-line">{service.description || "No description provided"}</p>
              </div>
            </div>
